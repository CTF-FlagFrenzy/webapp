...
<div class="px-8 pt-14">
  ...
  <div class="flex items-center justify-center">
    <div class="w-full bg-custom-110 mt-4 px-2 sm:!px-4 py-4 rounded-2xl sm:!w-2/3 shadow-BackdropShadow">
      ...
      <table class="styled-table w-full mt-4 table-fixed">
        <thead class="text-custom-200 text-lg sm:!text-xl sticky top-0 bg-custom-110 border-b z-10 border-custom-200">
          <tr>
            <th class="pl-4 text-left w-1/3">Name</th>
            <th class="text-center w-1/3">Firstbloods</th>
            <th class="pr-4 text-right w-1/3">Points</th>
          </tr>
        </thead>
        <tbody class="text-white text-sm">
          {#each teams as team}
            <tr class="border-b border-custom-100">
              <td class="pl-4 pt-2 align-top text-left break-words">{team.Teamname}</td>
              <td class="pt-2 align-top text-center">{team.FirstBloods}</td>
              <td class="pr-4 pt-2 align-top text-right">{team.Points}</td>
            </tr>
          {/each}
        </tbody>
      </table>
